...
PHOTON_ROUTER_IP=192.168.1.10
PHOTON_ROUTER_GW=192.168.1.1
PHOTON_ROUTER_DNS=192.168.1.1
SETUP_DNS_SERVER=1
...
if [ ${SETUP_DNS_SERVER} -eq 1 ]; then
    ...
    local-data: "router.tanzu.local A 192.168.1.10"
    local-data-ptr: "192.168.1.10 router.tanzu.local"

    local-data: "vcsa.tanzu.local A 192.168.1.11"
    local-data-ptr: "192.168.1.11 vcsa.tanzu.local"

    local-data: "haproxy.tanzu.local A 192.168.1.12"
    local-data-ptr: "192.168.1.12 haproxy.tanzu.local"

    local-data: "esxi-01.tanzu.local A 192.168.1.2"
    local-data-ptr: "192.168.1.2 esxi-01.tanzu.local"
