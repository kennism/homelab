...
- Installing/configuring a `LoadBalancer` service such as, for example, `metallb` or `avi` is _NOT_ part of this guide. If a `LoadBalancer` is not available, a guide on how to install/configure `metallb` is available in step 5 of this document.
